...
runtime analysis of the algorithms used to create convex hulls for the same input.
...
that there will be points in the convex hull that are collinear with others, 
